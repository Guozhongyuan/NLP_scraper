...
def get_url(time_0='2022-03-22', time_1='2022-03-23', pages=100):
    ...
    for page in range(1, pages+1):
        url = f"https://reportapi.eastmoney.com/report/list?cb=datatable7910445&industryCode=*&pageSize=50&industry=*&rating=&ratingChange=&beginTime={time_0}&endTime={time_1}&pageNo={page}&fields=&qType=0&orgCode=&code=*&rcode=&p={page}&pageNum={page}&pageNumber={page}"
        url_list.append(url)
    return url_list
...
if __name__ == '__main__':
    ...
    with open('./files/eastmoney_ggyb.pkl', 'wb') as f:
